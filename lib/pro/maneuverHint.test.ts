...
const view = (over: Partial<PlayerView>): PlayerView => ({
  ...
  tokens: [],
  self: { id: "p1", heroId: "thrall", hand: [], deckCount: 20, discard: [], committedCard: null, counters: {} },
  opponent: { id: "p2", heroId: "the-mandalorian", handCount: 5, deckCount: 20, discard: [], hasCommitted: false, counters: {} },
  combat: null,
  prompt: null,
  winner: null,
  ...over,
