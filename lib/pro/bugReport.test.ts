...
const view = (over: Partial<PlayerView> = {}): PlayerView => ({
  ...
  players: [
    { id: "p1", heroId: "king-kong", you: true, hand: ["a#1", "b#1"], handCount: 2, deckCount: 20, discard: ["c#1"], committedCard: null, hasCommitted: false, counters: {} },
    { id: "p2", heroId: "baba-yaga", you: false, handCount: 5, deckCount: 18, discard: [], hasCommitted: false, counters: {} },
  ],
  combat: null,
  prompt: null,
  winner: null,
...
describe("buildBugReportUrl", () => {
  ...
  it("captures every seat in a 3-player game without a duel opponent", () => {
    const multiplayerView = view({
      ...
      players: [
        { id: "p1", heroId: "king-kong", you: true, hand: ["a#1", "b#1"], handCount: 2, deckCount: 20, discard: ["c#1"], committedCard: null, hasCommitted: false, counters: {} },
        { id: "p2", heroId: "baba-yaga", you: false, handCount: 5, deckCount: 18, discard: [], hasCommitted: false, counters: { rage: 2 } },
        { id: "p3", heroId: "bigfoot", you: false, handCount: 4, deckCount: 17, discard: ["d#1"], hasCommitted: false, counters: {} },
      ],
    });
