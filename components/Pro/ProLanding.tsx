...
const MODES = [
  ...
  {
    title: "Eight boards — or yours",
    text: "The Mended Drum, Island of Despair, City Docks, Polus, Weathertop, Count's Castle, USCSS Nostromo, The Bog — or import a custom map.",
  },
  {
