...
const MODES = [
  ...
  {
    title: "Nine boards — or yours",
    text: "The Mended Drum, Island of Despair, City Docks, Polus, Weathertop, Count's Castle, USCSS Nostromo, The Bog, Wedding Crashers — or import a custom map.",
  },
  {
